...
import { itemDetails } from './state.js';
...
/**
 * Inicializa os elementos do leitor e anexa os listeners de eventos.
 */
export function initPlayerControls() {
    // ... (rest of the player logic)
}

// ... (todas as outras funções do leitor como `initPlayer`, `formatTime`, `togglePlay`, etc.)
// ... (movido do `script.js` original para aqui)
