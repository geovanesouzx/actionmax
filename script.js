...
        if (!container) {
            console.error(`Container com ID "${containerId}" não encontrado para renderizar a grade.`);
            return;
        }

        if (items.length === 0) {
            container.innerHTML = `<p class="col-span-full text-center text-gray-400">Nenhum conteúdo encontrado nesta categoria.</p>`;
            return;
        }
