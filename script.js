...
document.addEventListener('DOMContentLoaded', () => { 
    ...
    const profileButtonSidebar = document.getElementById('profile-button-sidebar'); 
    ...
    function renderHomePage() { 
        ...
        if (heroItem) { 
            ...
            heroButtons.innerHTML = ` 
                <button class="btn btn-primary"><i class="fa-solid fa-play"></i> Assistir Agora</button> 
                <button class="btn btn-secondary"><i class="fa-solid fa-circle-info"></i> Detalhes</button> 
            `; 
        ...
        if (item.type === 'Série' && item.seasons) { 
            ...
            const renderEpisodes = (seasonNum) => { 
                ...
                Object.entries(seasonData).sort((a,b) => parseInt(a[0]) - parseInt(b[0])).forEach(([epNum, epData], index) => { 
                    ...
                    epCard.className = 'episode-card group animate-fade-in-up'; 
    ...
    async function initializeApp(user) { 
        ...
        const unsubUser = onSnapshot(userDocRef, (userDoc) => { 
            ...
            document.getElementById('sidebar-avatar').src = currentUserData.avatarUrl || 'https://placehold.co/40x40/9ca3af/ffffff?text=U'; 
            document.getElementById('sidebar-username').textContent = currentUserData.displayName;
    ...
    profileButtonSidebar.addEventListener('click', () => { 
